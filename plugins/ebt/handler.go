...
func New(i logging.Interface, id *ssb.FeedRef, rootLog margaret.Log, userFeeds multilog.MultiLog, graphBuilder graph.Builder) muxrpc.Handler {
	return &handler{
		info:         i,
		id:           id,
		rootLog:      rootLog,
